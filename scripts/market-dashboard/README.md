...
Build command in this repository:

```bash
npm run market-dashboard:build-data
```

This writes fresh files into `public/market-dashboard/data` for the `/market-dashboard` page.
